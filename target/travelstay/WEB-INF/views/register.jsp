...
<head>
    <meta charset="UTF-8">
    <title>Register - TravelStay</title>
...
<div class="container narrow" style="padding-top:40px;">
    <div class="panel">
        ...
        <form method="post" action="${pageContext.request.contextPath}/register">
            ...
            <button type="submit" class="btn full" style="margin-top:16px;">Register</button>
        </form>
        <p style="text-align:center; margin-top:16px;">Already have an account? <a href="${pageContext.request.contextPath}/login">Login here</a></p>
    </div>
</div>
</body>
</html>
